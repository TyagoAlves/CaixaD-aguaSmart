...
void setupConfigServerRoutes() {
  configServer.on("/", HTTP_GET, []() {
    String html = "<!DOCTYPE html><html lang='pt-br'><head><meta charset='UTF-8'><title>Configuração Wi-Fi</title>"
      "<style>"
  ...
  configServer.on("/", HTTP_POST, []() {
    ...
    configServer.send(200, "text/html; charset=utf-8", "<!DOCTYPE html><html lang='pt-br'><head><meta charset='UTF-8'><title>Configuração</title></head><body><h2>Configuração recebida! O ESP irá reiniciar para conectar à rede.</h2></body></html>");
    delay(2000);
    ESP.restart();
  });
  configServer.on("/debug", HTTP_GET, []() {
    String html = "<!DOCTYPE html><html lang='pt-br'><head><meta charset='UTF-8'><title>Depuração ESP8266</title></head><body>";
    html += "<h2>Depuração ESP8266</h2>";
    html += "<ul>";
