...
void startAPMode() {
  ...
  configServer.on("/", HTTP_GET, []() {
    String html = "<h2>Configuração Wi-Fi</h2><form method='POST'><input name='ssid' placeholder='SSID'><br><input name='pass' placeholder='Senha' type='password'><br><button type='submit'>Salvar</button></form>";
  ...
  configServer.on("/", HTTP_POST, []() {
    ...
    configServer.send(200, "text/html", "<h2>Salvo! Reinicie o dispositivo.</h2>");
    delay(2000);
    ESP.restart();
  });
  configServer.begin();
